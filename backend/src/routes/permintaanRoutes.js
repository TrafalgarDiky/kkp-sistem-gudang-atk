...
router.get('/tugas', requireAuth, requireRole(['ADMIN', 'PETUGAS']), listTugasPetugas);
// PATCH /api/permintaan/tugas/:id/ambil — Petugas ambil tugas
router.patch('/tugas/:id/ambil', requireAuth, requireRole(['PETUGAS']), ambilTugas);
// PATCH /api/permintaan/tugas/:id/lepas — Petugas lepas tugas
router.patch('/tugas/:id/lepas', requireAuth, requireRole(['PETUGAS']), lepasTugas);
// PATCH /api/permintaan/tugas/:id — Petugas tandai selesai (stok berkurang)
router.patch('/tugas/:id', requireAuth, requireRole(['PETUGAS']), updateTugasStatus);
...
router.patch('/:id/approve', requireAuth, requireRole(['ADMIN']), approvePermintaan);
